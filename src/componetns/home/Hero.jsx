  ...
  return (
    <div className="relative w-full pt-30 h-screen flex items-center justify-start text-white overflow-hidden">
      ...
      >
        ...
        <motion.h1
          variants={textItemVariants}
          className="text-2xl text-white md:text-7xl font-serif font-bold my-4 leading-tight"
        >
          {heroData.headline}
        </motion.h1>
        <motion.p
        ...
        <motion.div variants={textItemVariants} className="flex gap-4 mb-8">
          <Link to="/contact">
            <button className="bg-transparent text-xl border border-orange-400 hover:border-orange-500 hover:bg-white/20 text-orange-400 hover:text-orange-500 font-semibold px-6 py-3 rounded-md transition-colors">
              Contact Us
            </button>
          </Link>
        </motion.div>
